...
namespace Synty.AnimationBaseLocomotion.Samples
{
    public class SamplePlayerAnimationController : MonoBehaviour
    {
        ...
        private readonly int _movementInputTappedHash = UnityEngine.Animator.StringToHash("MovementInputTapped");
        private readonly int _movementInputPressedHash = UnityEngine.Animator.StringToHash("MovementInputPressed");
        private readonly int _movementInputHeldHash = UnityEngine.Animator.StringToHash("MovementInputHeld");
        private readonly int _shuffleDirectionXHash = UnityEngine.Animator.StringToHash("ShuffleDirectionX");
        private readonly int _shuffleDirectionZHash = UnityEngine.Animator.StringToHash("ShuffleDirectionZ");

        private readonly int _moveSpeedHash = UnityEngine.Animator.StringToHash("MoveSpeed");
        private readonly int _currentGaitHash = UnityEngine.Animator.StringToHash("CurrentGait");

        private readonly int _isJumpingAnimHash = UnityEngine.Animator.StringToHash("IsJumping");
        private readonly int _fallingDurationHash = UnityEngine.Animator.StringToHash("FallingDuration");

        private readonly int _inclineAngleHash = UnityEngine.Animator.StringToHash("InclineAngle");

        private readonly int _strafeDirectionXHash = UnityEngine.Animator.StringToHash("StrafeDirectionX");
        private readonly int _strafeDirectionZHash = UnityEngine.Animator.StringToHash("StrafeDirectionZ");

        private readonly int _forwardStrafeHash = UnityEngine.Animator.StringToHash("ForwardStrafe");
        private readonly int _cameraRotationOffsetHash = UnityEngine.Animator.StringToHash("CameraRotationOffset");
        private readonly int _isStrafingHash = UnityEngine.Animator.StringToHash("IsStrafing");
        private readonly int _isTurningInPlaceHash = UnityEngine.Animator.StringToHash("IsTurningInPlace");

        private readonly int _isCrouchingHash = UnityEngine.Animator.StringToHash("IsCrouching");

        private readonly int _isWalkingHash = UnityEngine.Animator.StringToHash("IsWalking");
        private readonly int _isStoppedHash = UnityEngine.Animator.StringToHash("IsStopped");
        private readonly int _isStartingHash = UnityEngine.Animator.StringToHash("IsStarting");

        private readonly int _isGroundedHash = UnityEngine.Animator.StringToHash("IsGrounded");

        private readonly int _leanValueHash = UnityEngine.Animator.StringToHash("LeanValue");
        private readonly int _headLookXHash = UnityEngine.Animator.StringToHash("HeadLookX");
        private readonly int _headLookYHash = UnityEngine.Animator.StringToHash("HeadLookY");

        private readonly int _bodyLookXHash = UnityEngine.Animator.StringToHash("BodyLookX");
        private readonly int _bodyLookYHash = UnityEngine.Animator.StringToHash("BodyLookY");

        private readonly int _locomotionStartDirectionHash = UnityEngine.Animator.StringToHash("LocomotionStartDirection");
