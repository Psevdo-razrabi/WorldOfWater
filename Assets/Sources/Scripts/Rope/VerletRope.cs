...
public class VerletRope : MonoBehaviour
{
    ...
    {
        float currentDistance = Vector3.Distance(_attachPoint.position, _defaultPoint.position);
        m_RopeLength = currentDistance;
        m_DistanceBetweenNodes = m_RopeLength / m_NumberOfNodes;
    ...
    {
        m_VerletNodes[0].Position = _attachPoint.position;
        ...
        m_VerletNodes[m_VerletNodes.Length - 1].Position = _defaultPoint.position;
    }
