...
namespace UnityEngine.AzureSky
{
    ...
    public class AzureWeatherController : MonoBehaviour
    {
        ...
        private float m_weatherRamp = 0.0f;
        ...
        [SerializeField] private float m_timeOfDayClamped = 6.0f;
        ...
        private void EvaluateWeatherProfiles()
        {
            ...
            if (m_azureTimeController)
            {
                ...
                if (m_azureTimeController.TimeSystem == AzureTimeSystem.Realistic)
                {
                    m_timeOfDayClamped = Mathf.InverseLerp(-1.0f, 1.0f, m_azureTimeController.GetSunElevation());
                    m_timeOfDay = Mathf.Lerp(0.0f, 12.0f, m_timeOfDayClamped);
                }
            }
            ...
            for (int index = 0; index < overrideObject.customPropertyList.Count; index++)
            {
                switch (overrideObject.customPropertyList[index].outputType)
                {
                    case AzureOutputType.Float:
                        m_overridePropertyList[index].floatOutput = m_currentWeatherProfile.profilePropertyList[index].GetFloatOutput(m_timeOfDay);
                    ...
                    case AzureOutputType.Color:
                        m_overridePropertyList[index].colorOutput = m_currentWeatherProfile.profilePropertyList[index].GetColorOutput(m_timeOfDay);
                        // Loop through the setup property list within the override property list
                        for (int innerIndex = 0; innerIndex < m_overridePropertyList[index].overridePropertySetupList.Count; innerIndex++)
                        {
                            m_profileMultiplier = m_overridePropertyList[index].overridePropertySetupList[innerIndex].multiplier;
        ...
        private void ApplyGlobalWeatherTransition(AzureWeatherProfile from, AzureWeatherProfile to, float t)
        {
            ...
            for (int index = 0; index < overrideObject.customPropertyList.Count; index++)
            {
                m_weatherRamp = to.profilePropertyList[index].rampCurve.Evaluate(t);

                switch (overrideObject.customPropertyList[index].outputType)
                {
                    case AzureOutputType.Float:
                        m_overridePropertyList[index].floatOutput = FloatInterpolation(from.profilePropertyList[index].GetFloatOutput(m_timeOfDay),
                                                                   to.profilePropertyList[index].GetFloatOutput(m_timeOfDay), m_weatherRamp);
                        // Loop through the setup property list within the override property list
                        for (int innerIndex = 0; innerIndex < m_overridePropertyList[index].overridePropertySetupList.Count; innerIndex++)
                        {
                            m_profileMultiplier = m_overridePropertyList[index].overridePropertySetupList[innerIndex].multiplier;
                    ...
                    case AzureOutputType.Color:
                        m_overridePropertyList[index].colorOutput = ColorInterpolation(from.profilePropertyList[index].GetColorOutput(m_timeOfDay),
                                                                   to.profilePropertyList[index].GetColorOutput(m_timeOfDay), m_weatherRamp);
                        // Loop through the setup property list within the override property list
                        for (int innerIndex = 0; innerIndex < m_overridePropertyList[index].overridePropertySetupList.Count; innerIndex++)
                        {
                            m_profileMultiplier = m_overridePropertyList[index].overridePropertySetupList[innerIndex].multiplier;
        ...
        private void ApplyWeatherZonesInfluence(AzureWeatherProfile localZoneProfile, float t)
        {
            ...
            for (int index = 0; index < overrideObject.customPropertyList.Count; index++)
            {
                m_weatherRamp = localZoneProfile.profilePropertyList[index].rampCurve.Evaluate(t);

                switch (overrideObject.customPropertyList[index].outputType)
                {
                    case AzureOutputType.Float:
                        m_overridePropertyList[index].floatOutput = FloatInterpolation(m_overridePropertyList[index].floatOutput, localZoneProfile.profilePropertyList[index].GetFloatOutput(m_timeOfDay), m_weatherRamp);
                        // Loop through the setup property list within the override property list
                        for (int innerIndex = 0; innerIndex < m_overridePropertyList[index].overridePropertySetupList.Count; innerIndex++)
                        {
                            m_profileMultiplier = m_overridePropertyList[index].overridePropertySetupList[innerIndex].multiplier;
                    ...
                    case AzureOutputType.Color:
                        m_overridePropertyList[index].colorOutput = ColorInterpolation(m_overridePropertyList[index].colorOutput, localZoneProfile.profilePropertyList[index].GetColorOutput(m_timeOfDay), m_weatherRamp);
                        // Loop through the setup property list within the override property list
                        for (int innerIndex = 0; innerIndex < m_overridePropertyList[index].overridePropertySetupList.Count; innerIndex++)
                        {
                            m_profileMultiplier = m_overridePropertyList[index].overridePropertySetupList[innerIndex].multiplier;
